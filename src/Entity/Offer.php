 ...
 * Offer
 *
 * @ORM\Table(name="offer", indexes={@ORM\Index(name="category_id", columns={"category_id"}), @ORM\Index(name="contact_id", columns={"contact_id"})})
 * @ORM\Entity
 */
class Offer
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="Candidate", mappedBy="offer")
     */
    private $candidate;
